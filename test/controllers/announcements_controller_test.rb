  ...
  test 'should create announcement' do
    assert_difference('Announcement.count') do
      post announcements_url,
           params: { announcement: { announcement_id: @announcement.announcement_id, description: @announcement.description,
                                     posted_on: @announcement.posted_on, title: @announcement.title, user_id: @announcement.user_id } }
    end
