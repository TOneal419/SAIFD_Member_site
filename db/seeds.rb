...
User.create(id: -1, email: 'wjmckinley@tamu.edu', first_name: 'blah', last_name: 'test', report_rate: 'Disabled', class_year: 2024, permission_id: -1, created_at: '3/3/2022', updated_at: '3/3/2022')
...
User.create(id: -2, email: 'bill.mckinley@ag.tamu.edu', first_name: 'blah', last_name: 'test', report_rate: 'Disabled', class_year: 2024, permission_id: -2, created_at: '3/3/2022', updated_at: '3/3/2022')
